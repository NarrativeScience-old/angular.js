/**
 * @license AngularJS v1.2.19-local+sha.9c95940
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.19-local+sha.9c95940/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.19-local+sha.9c95940',    // all of these placeholder strings will be replaced by grunt's
